...
class Instance(object):
    ...
    def modify_field(self, field, new_instance, self_modified=False):
        ...
        self.event_modified.send(self, field, self_modified)
    ...
    def subfield_linked(self, src_subfield_hierarchy, src_subfield_instance):
        ...
        for subfield_hierarchy in self.cls.links.set_of(src_subfield_hierarchy):
    ...
    def subfield_unlinked(self, subfield_hierarchy):
        ...
        subfield_parent_instance.modify_field(subfield_hierarchy[-1], new_subfield_instance)
    ...
    def modify_field_by_name(self, name, field_instance, self_modified=False):
        self.modify_field(self.fields_by_name()[name], field_instance, self_modified=self_modified)
